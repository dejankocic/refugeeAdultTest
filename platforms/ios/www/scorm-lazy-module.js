...
/* harmony import */ var _components_index_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/index/index */ "./src/addons/mod/scorm/components/index/index.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonModScormIndexPage = class AddonModScormIndexPage extends _features_course_classes_main_activity_page__WEBPACK_IMPORTED_MODULE_2__["CoreCourseModuleMainActivityPage"] {
    ...
    ngOnInit() {
        super.ngOnInit();
        if (_services_navigator__WEBPACK_IMPORTED_MODULE_3__["CoreNavigator"].getRouteBooleanParam('autoPlay')) {
            this.autoPlayData = {
                mode: _services_navigator__WEBPACK_IMPORTED_MODULE_3__["CoreNavigator"].getRouteParam('mode'),
                newAttempt: _services_navigator__WEBPACK_IMPORTED_MODULE_3__["CoreNavigator"].getRouteBooleanParam('newAttempt'),
                organizationId: _services_navigator__WEBPACK_IMPORTED_MODULE_3__["CoreNavigator"].getRouteParam('organizationId'),
                scoId: _services_navigator__WEBPACK_IMPORTED_MODULE_3__["CoreNavigator"].getRouteNumberParam('scoId'),
            };
        }
    }
};
AddonModScormIndexPage.propDecorators = {
    activityComponent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: [_components_index_index__WEBPACK_IMPORTED_MODULE_4__["AddonModScormIndexComponent"],] }]
};
