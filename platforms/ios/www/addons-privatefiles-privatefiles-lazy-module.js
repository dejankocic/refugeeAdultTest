...
function buildRoutes(injector) {
    return [
        {
            path: 'root',
            loadChildren: () => Promise.all(/*! import() | pages-index-index-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-index-index-module")]).then(__webpack_require__.bind(null, /*! ./pages/index/index.module */ "./src/addons/privatefiles/pages/index/index.module.ts")).then(m => m.AddonPrivateFilesIndexPageModule),
        },
        {
            path: ':hash',
            loadChildren: () => Promise.all(/*! import() | pages-index-index-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-index-index-module")]).then(__webpack_require__.bind(null, /*! ./pages/index/index.module */ "./src/addons/privatefiles/pages/index/index.module.ts")).then(m => m.AddonPrivateFilesIndexPageModule),
